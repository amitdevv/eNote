      ...
      <section className="pt-4 sm:pt-6 pb-8 sm:pb-12 lg:pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="px-6 sm:px-8 lg:px-12 py-6 sm:py-8 lg:py-10">
              ...
              <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-8 md:gap-12 lg:gap-16 px-2">
                {/* Docs */}
                <div className="flex flex-col items-center gap-1.5 sm:gap-2">
                  ...
                  <span className="text-xs sm:text-sm md:text-base font-medium text-gray-700">Docs</span>
                </div>
                ...
                <div className="flex flex-col items-center gap-1.5 sm:gap-2">
                  ...
                  <span className="text-xs sm:text-sm md:text-base font-medium text-gray-700">Tasks</span>
                </div>
                ...
                <div className="flex flex-col items-center gap-1.5 sm:gap-2">
                  ...
                  <span className="text-xs sm:text-sm md:text-base font-medium text-gray-700">Whiteboards</span>
                </div>
                ...
                <div className="flex flex-col items-center gap-1.5 sm:gap-2">
                  ...
                  <span className="text-xs sm:text-sm md:text-base font-medium text-gray-700">Daily Notes</span>
                </div>
              </div>
          </div>
        </div>
